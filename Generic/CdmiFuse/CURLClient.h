...
namespace common
{
		...
		public:
			...
			CURLClient(char* url, ZQ::common::Log& log, ZQ::common::NativeThreadPool& thrdpool, uint32 flag = 0, HTTPMETHOD method = HTTP_GET, std::string clientId ="", char* bindIp = "0.0.0.0");
