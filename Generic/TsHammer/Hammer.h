...
public:
	ConsoleWriter(Hammer& hammer, uint clients, uint iter, uint loop, bool print=true);
...
public: 
	...
	typedef std::vector<ZQ::common::RTSPClient*> RTSPClients;
...
public:
	...
	ZQ::common::RTSPClient* getClient(uint idx) const;
