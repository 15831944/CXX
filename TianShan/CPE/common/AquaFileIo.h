...
#ifndef ZQTS_CPE_AQUAFILEIO_H
#define ZQTS_CPE_AQUAFILEIO_H
...
class AquaFileIoFactory;

class ZQ_COMMON_API AquaFileIo : public FileIo
{
public:
	friend class AquaFileIoFactory;

	AquaFileIo(AquaFileIoFactory* pFileIoFactory);
	virtual ~AquaFileIo();
