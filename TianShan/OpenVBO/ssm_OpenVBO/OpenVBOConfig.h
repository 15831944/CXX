...
struct Announce
{
	...
	int32 _SRMEnabled;
	int32 _STBEnabled;
	int32 _sendTianShanStateChangeAnnounce;
	int32 _sendTianShanScaleChangeAnnounce;
...
struct OpenVBOConfig
{
	...
	typedef ZQ::common::Config::Holder<OpenVBOConfig> ISVodConfigHolder;
...
extern ZQ::common::Config::Loader<EventISVODI5::OpenVBOConfig> _openVBOConfig;
