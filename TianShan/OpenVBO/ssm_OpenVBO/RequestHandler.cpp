...
void RequestHandler::composeResponse()
{
	...
	if (_statusCode < 200 || _statusCode >= 300)
	{
        ...
        // ticket#17446 and bug#20887, remove "Notice" from response header
...
{
	_env.getResourceManager().applyPenalty(_session, _streamerNetId, _streamersConfig._streamingResource._maxPenaltyValue);
}
