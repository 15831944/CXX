...
struct SnmpSenderInfo
{
	...
	static void structure(Config::Holder< SnmpSenderInfo > &holder)
    {
		...
		holder.addDetail("EventSender/SnmpSender/Other", "dequeSize", &SnmpSenderInfo::dequeSize, NULL);
		holder.addDetail("EventSender/SnmpSender/Other", "savePath", &SnmpSenderInfo::savePath, NULL);
	}
