...
#define ZQ_FILE_DESCRIPTION        	ZQ_PRODUCT_NAME ": EventGw Helper for CMEService"
#ifdef _DEBUG
#define ZQ_INTERNAL_FILE_NAME      	"EGH_SOAP_CME_d"
#else
#define ZQ_INTERNAL_FILE_NAME      	"EGH_SOAP_CME"
#endif // _DEBUG
