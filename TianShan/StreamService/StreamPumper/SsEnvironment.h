...
const char* const	EVENT_ITEMSTEP_TIME_STAMP_UTC			= "EventStep-TimeStampUTC";
const char* const	EVENT_ITEMSTEP_PREV_ITEM_PID			= "EventStep-ItemPreviousPID";
const char* const	EVENT_ITEMSTEP_PREV_ITEM_PAID			= "EventStep-ItemPreviousPAID";
const char* const	EVENT_ITEMSTEP_CUR_ITEM_PID				= "EventStep-ItemCurrentPID";
const char* const	EVENT_ITEMSTEP_CUR_ITEM_PAID			= "EventStep-ItemCurrentPAID";
const char* const	EVENT_ITEMSTEP_PREV_STREAMSOURCE		= "EventStep-ItemPreviousStreamingSource";
const char* const	EVENT_ITEMSTEP_CUR_STREAMSOURCE			= "EventStep-ItemCurerntStreamingSoucre";
...
const char* const	EVENT_ITEMSTEP_ITEM_CUR_TIMEOFFSET		= "EventStep-ItemCurrentTimeOffset";
const char* const	EVENT_ITEMSTEP_CLSUTERID				= "EventStep-ClusterId";
const char* const	EVENT_ITEMSTEP_EVENT_SEQ				= "EventStep-EventSeq";

//for ICE_EVENT_TYPE_ENDOFSTREAM and ICE_EVENT_TYPE_BEGINOFSTREAM
const char* const	EVENT_STREAM_COMPLETE_EVENT_SEQ			= "EventStreamComplete-EventSeq";
const char* const	EVENT_STREAM_COMPLETE_TIMEOFFSET		= "EventStreamComplete-TimeOffset";


//for ICE_EVENT_TYPE_SPEEDCHANGE
const char* const	EVENT_SPEEDCHANGE_PREV_SPEED			= "EventSpeedChange_PreviousSpeed";
const char* const	EVENT_SPEEDCHANGE_CUR_SPEED				= "EventSpeedChange_CurrentSpeed";
const char* const	EVENT_SPEEDCHANGE_CUR_ITEM_NAME			= "EventSpeedChange_CurrentItemName";
const char* const	EVENT_SPEEDCHANGE_CUR_CTRLNUM			= "EventSpeedChange_CurrentCtrlNum";
const char* const	EVENT_SPEEDCHANGE_EVENT_SEQ				= "EventSpeedChange_EventSeq";

//for ICE_EVENT_TYPE_STATECHANGE
const char* const	EVENT_STATECHANGE_PREV_STATE			= "EventStateChange_PrevState";
const char* const	EVENT_STATECHANGE_CUR_STATE				= "EventStateChange_CurrentState";
const char* const	EVENT_STATECHANGE_CUR_ITEMANEM			= "EventStateChange_CurrentItemName";
const char* const	EVENT_STATECHANGE_CUR_CTRLNUM			= "EventStateChange_CurrentCtrlNum";
const char* const	EVENT_STATECHANGE_EVENTSEQ				= "EventStateChange_EventSeq";
...
const char* const	EVENT_PLDESTROY_EXIT_REASON				= "EventPlDestroyed_ExitReason";
