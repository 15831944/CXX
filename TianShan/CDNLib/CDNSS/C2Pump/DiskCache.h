...
#define FLUSH_INTERVAL_MIN      (WAIT_INTERVAL_MIN>>1)  // 10msec
#define FLUSH_INTERVAL_DEFAULT  (100)     // 400msec maps to 20MBps disk-write speed 
class CacheFlusher : public ZQ::common::NativeThread, virtual public ZQ::common::SharedObject
{
public:
	typedef ZQ::common::Pointer< CacheFlusher > Ptr;
	typedef std::vector < Ptr > List;

	CacheFlusher(CacheDir& dir) : _dir(dir) {}
