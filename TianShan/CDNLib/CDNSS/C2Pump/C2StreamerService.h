...
public:
	...
	class IndexRecordWrapper: public ZQ::IdxParser::IndexRecord, public ZQ::common::SharedObject {
	public:
	...
	typedef ZQ::common::Pointer<IndexRecordWrapper> IndexRecordWrapperPtr;
...
public:
	...
	inline C2UdpInfoQuery::Ptr	getUdpInfoQuerier();
...
private:
	...
	C2UdpInfoQuery::Ptr           mUdpInfoQuery;
	struct WatchKey 
	{
		C2SessionPtr	sess;
		uint64			targetTime;
...
C2UdpInfoQuery::Ptr C2Service::getUdpInfoQuerier() {
	return mUdpInfoQuery;
}
