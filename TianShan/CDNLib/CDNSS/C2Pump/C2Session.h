...
public:
	...
	int 					checkFileData(const RequestParamPtr  request,bool& cacheAble, RequestResponseParamPtr response );
	...
	int         			checkFileAttr(const RequestParamPtr request,bool& cacheAble,  RequestResponseParamPtr response, const BufferUser& bu);
