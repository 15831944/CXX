...
public:
	...
	void			unregisterSession( const std::string& clientIp , const std::string& sessId, int64 requestBW );
...
public:
	...
	AssetAttribute::Ptr	getAssetAttribute(const std::string& sessId, const std::string& filename, int readerType );

	int64 				genSubSessionId();
