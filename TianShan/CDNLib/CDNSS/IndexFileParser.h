...
private:
	...
	const uint64 getLastOffset() const {
		return mLastOffset;
	}
...
protected:
	...
	int32			getTag( FileReader* reader , IndexRecordHeader& tal );
...
public:
	...
	int32	        ParseIndexRecodFromMemoryPWE( const std::string& mainFilePathName, IndexRecord& record, const char* buffer, size_t size);
