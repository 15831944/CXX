...
struct AquaReaderConf
{
	...
	static void structure( ZQ::common::Config::Holder<AquaReaderConf>& holder ) {
		...
		holder.addDetail("", "contentNameFormat",&AquaReaderConf::contentNameFormat, "${PAID}${PID}",optReadOnly);
...
struct C2StreamerWriter
{
	...
	static void structure( ZQ::common::Config::Holder<C2StreamerWriter>& holder )
	{
		...
		holder.addDetail("", "minYieldInterval", &C2StreamerWriter::minYieldInterval,"100",optReadOnly);
...
//	std::string				csStrReplicaId;
	...
	static void structure( ZQ::common::Config::Holder<CdnSSConfig>& holder )
	{
		using namespace ZQ::common::Config;
		holder.addDetail("default/EventChannel","endpoint",&CdnSSConfig::eventChannelEndpoint,"",optReadOnly);
		holder.addDetail("default/CrashDump","path",&CdnSSConfig::crashDumpPath,"",optReadOnly);
		holder.addDetail("default/CrashDump","enabled",&CdnSSConfig::enableCrashDump,"0",optReadOnly);
		holder.addDetail("default/IceTrace","enabled",&CdnSSConfig::enableIceTrace,"0",optReadOnly);
		holder.addDetail("default/IceTrace","level",&CdnSSConfig::iceTraceLevel,"7",optReadOnly);
		holder.addDetail("default/IceTrace","size",&CdnSSConfig::iceTraceLogSize,"10240000",optReadOnly);
		holder.addDetail("default/IceProperties/serviceProperty",&CdnSSConfig::readIceProperty,&CdnSSConfig::registerNothing);
		holder.addDetail("default/Database","path",&CdnSSConfig::dbPath,"",optReadOnly);

		//C2StreamerSvcConfig

		//service
		holder.addDetail("CdnSS","netId",&CdnSSConfig::netId,"",optReadOnly);
		holder.addDetail("CdnSS/Bind","endpoint",&CdnSSConfig::serviceEndpoint,"",optReadOnly);
		holder.addDetail("CdnSS/Bind","dispatchSize",&CdnSSConfig::dispatchThreadCount,"5",optReadOnly);
		holder.addDetail("CdnSS/Bind","dispatchMax",&CdnSSConfig::dispatchThreadCountMax,"10",optReadOnly);
		holder.addDetail("CdnSS/RequestProcess","threads",&CdnSSConfig::mainThreadCount,"5",optReadOnly);

		holder.addDetail("CdnSS/C2Streamer",&CdnSSConfig::readC2StreamerConf,&CdnSSConfig::registerNothing);
		holder.addDetail("CdnSS/HLSServer",&CdnSSConfig::readHLSServerConfig,&CdnSSConfig::registerNothing);

		//publish log
		holder.addDetail("CdnSS/PublishedLogs/Log",&CdnSSConfig::readMonitoredLog,&CdnSSConfig::registerNothing);

		//session
		holder.addDetail("CdnSS/StreamSession","timeout",&CdnSSConfig::sessionTimeout,"600000",optReadOnly);
		//ticketRenewInterval
		holder.addDetail("CdnSS/StreamSession","sessionScanInterval",&CdnSSConfig::sessionScanInterval,"5000",optReadOnly);
		holder.addDetail("CdnSS/StreamSession","ticketRenewInterval",&CdnSSConfig::ticketRenewInterval,"60000",optReadOnly);
		holder.addDetail("CdnSS/StreamSession","ticketRenewThreadpoolSize",&CdnSSConfig::ticketRenewThreadpoolSize,"5",optReadOnly);
		holder.addDetail("CdnSS/StreamSession","resourceScanInterval",&CdnSSConfig::resourceScanInterval,"100000",optReadOnly);
		//resourceScanInterval

		//replica
		holder.addDetail("CdnSS/Replica",&CdnSSConfig::readStreamerReplicaConfig, &CdnSSConfig::registerNothing);

		//performance tune
		holder.addDetail("CdnSS/PeformanceTune/IceFreezeEnviroment","CheckpointPeriod",&CdnSSConfig::perfCheckpointPeriod,"240",optReadOnly);
		holder.addDetail("CdnSS/PeformanceTune/IceFreezeEnviroment","DbRecoverFatal",&CdnSSConfig::perfDbRecoverFatal,"1",optReadOnly);
		holder.addDetail("CdnSS/PeformanceTune/session","sessionSize",&CdnSSConfig::perfSessionCacheSize,"200",optReadOnly);
		holder.addDetail("CdnSS/PeformanceTune/session","SavePeriod",&CdnSSConfig::perfSavePeriod,"60000",optReadOnly);
		holder.addDetail("CdnSS/PeformanceTune/session","SaveSizeTrigger",&CdnSSConfig::perfSaveSizeTrigger,"30",optReadOnly);
		holder.addDetail("CdnSS/PeformanceTune/session","useMemoryDB",&CdnSSConfig::perfUseMemoryDB,"0",optReadOnly);

		//assistant log
		holder.addDetail("CdnSS/AssistantLog/SessionLog","level",&CdnSSConfig::sessionLogLevel,"7",optReadOnly);
		holder.addDetail("CdnSS/AssistantLog/SessionLog","fileSize",&CdnSSConfig::sessionLogFileSize,"10240000",optReadOnly);
		holder.addDetail("CdnSS/AssistantLog/SessionLog","buffer",&CdnSSConfig::sessionLogBufferSize,"10240",optReadOnly);
		holder.addDetail("CdnSS/AssistantLog/SessionLog","flushTimeout",&CdnSSConfig::sessionLogTimeout,"2",optReadOnly);

		//CacheStore
		holder.addDetail("CacheStore",&CdnSSConfig::readCacheStoreConfig,&CdnSSConfig::registerNothing);

        // <ContentStore>
		holder.addDetail("ContentStore/Log/MainLog","level",&CdnSSConfig::mainLogLevel,"7",optReadOnly);
		holder.addDetail("ContentStore/Log/MainLog","fileSize",&CdnSSConfig::mainLogFileSize,"10240000",optReadOnly);
		holder.addDetail("ContentStore/Log/MainLog","buffer",&CdnSSConfig::mainLogBufferSize,"10240",optReadOnly);
		holder.addDetail("ContentStore/Log/MainLog","flushTimeout",&CdnSSConfig::mainLogTimeout,"2",optReadOnly);
		holder.addDetail("ContentStore/Log/EventLog","level",&CdnSSConfig::eventLogLevel,"7",optReadOnly);
		holder.addDetail("ContentStore/Log/EventLog","fileSize",&CdnSSConfig::eventLogFileSize,"10240000",optReadOnly);
		holder.addDetail("ContentStore/Log/EventLog","buffer",&CdnSSConfig::eventLogBufferSize,"10240",optReadOnly);
		holder.addDetail("ContentStore/Log/EventLog","flushTimeout",&CdnSSConfig::eventLogTimeout,"2",optReadOnly);

		holder.addDetail("ContentStore/Volumes","volCheckTimeout",&CdnSSConfig::csVolCheckTimeout,"30000",optReadOnly);
        holder.addDetail("ContentStore/Volumes/Volume", &CdnSSConfig::readVolumes, &CdnSSConfig::registerNothing);
        //holder.addDetail("ContentStore", "netId", &CdnSSConfig::netId, 0, optReadOnly);
        holder.addDetail("ContentStore", "cacheMode", &CdnSSConfig::isCacheMode, "0", optReadOnly);
        holder.addDetail("ContentStore", "cacheLevel", &CdnSSConfig::cacheLevel, "10", optReadOnly);
        holder.addDetail("ContentStore", "autoFileSync", &CdnSSConfig::isAutoSync, "0", optReadOnly);
        holder.addDetail("ContentStore","ThreadPoolSize",&CdnSSConfig::csThreadPoolSize,"20",optReadOnly);

        holder.addDetail("ContentStore/Provision", "defaultBandwidth", &CdnSSConfig::defaultProvisionBW, "3750000", optReadOnly);
        holder.addDetail("ContentStore/Provision", "trickSpeeds", &CdnSSConfig::strTrickSpeeds, "7.5", optReadOnly);
        holder.addDetail("ContentStore/Provision", "timeoutIdleProvisioning", &CdnSSConfig::csTimeoutIdleProvisioning, "172800000", optReadOnly);
        holder.addDetail("ContentStore/Provision", "timeoutNotProvisioned", &CdnSSConfig::csTimeoutNotProvisioned, "600000", optReadOnly);
		holder.addDetail("ContentStore/Provision","minimalMainfileSize",&CdnSSConfig::csMinimalMainfileSize,"2457600",optReadOnly);

        holder.addDetail("ContentStore/DatabaseCache", "volumeSize", &CdnSSConfig::volumeEvictorSize, "20", optReadOnly);
        holder.addDetail("ContentStore/DatabaseCache", "contentSize", &CdnSSConfig::contentEvictorSize, "500", optReadOnly);

        holder.addDetail("ContentStore/CPC", "endpoint", &CdnSSConfig::cpcEndpoint, 0, optReadOnly);
        holder.addDetail("ContentStore/CPC/Sessions", "registerInterval", &CdnSSConfig::cpcRegisterInterval, "15000", optReadOnly);
		holder.addDetail("ContentStore/CPC/Sessions", "DefaultIndexType", &CdnSSConfig::cpcDefaultIndexType, "VVC", optReadOnly);

        holder.addDetail("ContentStore/StoreReplica", "groupId", &CdnSSConfig::csStrReplicaGroupId, "");
//        holder.addDetail("ContentStore/StoreReplica", "replicaId", &CdnSSConfig::csStrReplicaId, "");
        holder.addDetail("ContentStore/StoreReplica", "replicaPriority", &CdnSSConfig::csReplicaPriority, "0");
        holder.addDetail("ContentStore/StoreReplica", "timeout", &CdnSSConfig::csReplicaTimeout, "60");
        holder.addDetail("ContentStore/StoreReplica/MasterReplica", "endpoint", &CdnSSConfig::csMasterEndpoint, "");

		holder.addDetail("ContentStore/FileEvent","enableMulticast",&CdnSSConfig::csEnableEventMulticast ,"0",optReadOnly);
		holder.addDetail("ContentStore/FileEvent","groupAddress",&CdnSSConfig::csEventMulticastGroupIp,"",optReadOnly);
		holder.addDetail("ContentStore/FileEvent","groupPort",&CdnSSConfig::csEventMulticastGroupPort,"65002",optReadOnly);
		holder.addDetail("ContentStore/FileEvent","groupBind",&CdnSSConfig::csEventMulticastLocalIp,"",optReadOnly);
		holder.addDetail("ContentStore/FileEvent","neMappingSendInterval",&CdnSSConfig::csNeMappingSendInterval,"5000",optReadOnly);
		holder.addDetail("ContentStore/FileEvent","showAllMulticastEvent",&CdnSSConfig::csEventShowAll,"0",optReadOnly);
	}
};

}}

extern ZQ::common::Config::Loader<ZQ::StreamService::CdnSSConfig>	 gCdnSSConfig;
