...
void C2Env::registerSnmpVariables()
{
    ...
    _mmib.addObject(new ZQ::SNMP::SNMPObject("c2locLogSize", &_conf.logsize, ZQ::SNMP::AsnType_Int32));
    _mmib.addObject(new ZQ::SNMP::SNMPObject("c2locLamIf", &_conf.lamEndpoint, ZQ::SNMP::AsnType_String));
    _mmib.addObject(new ZQ::SNMP::SNMPObject("c2locForwardLocator", &_conf.forwardUrl, ZQ::SNMP::AsnType_String));
    _mmib.addObject(new ZQ::SNMP::SNMPObject("c2locOptSelectionRetryMax", &_conf.selectionRetryMax, ZQ::SNMP::AsnType_Int32));
    _mmib.addObject(new ZQ::SNMP::SNMPObject("c2locOptIdxRate", &_conf.indexFileTransferRate, ZQ::SNMP::AsnType_Int32));
    _mmib.addObject(new ZQ::SNMP::SNMPObject("c2locTotalBwKbps", &portPerf.totalBw, ZQ::SNMP::AsnType_Int32));
    _mmib.addObject(new ZQ::SNMP::SNMPObject("c2locActiveBwKbps", &portPerf.activeBw, ZQ::SNMP::AsnType_Int32));
    _mmib.addObject(new ZQ::SNMP::SNMPObject("c2locTransferCount", &portPerf.sessions, ZQ::SNMP::AsnType_Int32));
