...
void FixedSpeedSet::structure(FixedSpeedSet::FixedSpeedSetHolder& holder )
{
	...
	holder.addDetail("","enableSpeedLoop",&FixedSpeedSet::enableSpeedLoop,"0",ZQ::common::Config::optReadOnly);
}
...
void TSConfig::structure(TSConfigHolder& holder)
{
	...
	holder.addDetail("ssm_GBstb/LogFile", &TSConfig::readLogFile, &TSConfig::registerLogFile);
	holder.addDetail("ssm_GBstb/SessionManager", &TSConfig::readSessionManager, &TSConfig::registerSessionManager);
	holder.addDetail("ssm_GBstb/Bind", &TSConfig::readBind, &TSConfig::registerBind);
	holder.addDetail("ssm_GBstb/RTSPSession", &TSConfig::readRTSPSession, &TSConfig::registerRTSPSession);
	holder.addDetail("ssm_GBstb/DefaultParameter", &TSConfig::readDefaultParams, &TSConfig::registerDefaultParams);
	holder.addDetail("ssm_GBstb/Response", &TSConfig::readResponse, &TSConfig::registerResponse);
	holder.addDetail("ssm_GBstb/DoSProtection", &TSConfig::readDoSProtection, &TSConfig::registerDoSProtection);
	holder.addDetail("ssm_GBstb/IceProperties", &TSConfig::readIcePropertys, &TSConfig::registerIcePropertys);
	holder.addDetail("ssm_GBstb/PublishedLogs/Log", &TSConfig::readLogPublish, &TSConfig::registerIcePropertys);
	holder.addDetail("ssm_GBstb/VirtualServiceGroup", &TSConfig::readVirtualServiceGroup, &TSConfig::registerVirtualServiceGroup);
	holder.addDetail("ssm_GBstb/FixedSpeedSet",&TSConfig::readFixedSpeedSet,&TSConfig::regsiterFixedSpeedSet );
	holder.addDetail("ssm_GBstb/NGODS1",&TSConfig::readNGODS1,&TSConfig::registerNGODS1 );
}
