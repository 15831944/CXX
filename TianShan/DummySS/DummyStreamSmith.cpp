// DummyStreamSmith.cpp: implementation of the DummyStreamSmith class.
//
//////////////////////////////////////////////////////////////////////
...
extern DummyService*	_serviceInstance;
...
bool DBStore::UpdateStreamInstance( TianShanIce::Streamer::StreamPtr& streamPtr,Ice::Identity& id)
{
	...
	TRY_BEGIN()
		...
		id.name=szBuf;//purchasePtr->GetID();
		if( id.name.length()<=0 || (!m_DBEvictor->hasObject(id)) )
		{
			//glog(Log::L_DEBUG,"Update playlist attr with guid=%s",strGuid.c_str());			
			id.category=PURCHASE_CATAGORY;
			id.name=IceUtil::generateUUID();
			streamPtr->ident=id;
			Ice::ObjectPrx prx= m_DBEvictor->add(streamPtr,id);			
			glog(ZQ::common::Log::L_DEBUG,ICEDBFMT("add new record with category=%s name=%s"),
...
DummyService::DummyService(Ice::ObjectAdapterPtr& Adapter,const std::string& dbPath ,const std::string& netId,const std::vector<std::string>& streamers ,int target )
	:mWatchDog(this),m_Adapter(Adapter),_db(Adapter),mNetId(netId),mStreamers(streamers)
{
	mWatchDog.start();
	RLock sunc(*this);
	_db.Init(dbPath);
...
bool DummyService::UpdateStreamInstance(TianShanIce::Streamer::StreamPtr& streamPtr,
										Ice::Identity& id,
...
bool DummyService::ClearStreamInstance(const Ice::Identity& id)
{
	{
		ZQ::common::MutexGuard gd(_mapMutex);
		_map.erase(id.name);
...
TianShanIce::Streamer::StreamPrx DummyService::createStream(const ::TianShanIce::Transport::PathTicketPrx& ticket,
															const ::Ice::Current& )
{	
	...
	tempPause();
	DummyStream* s = new DummyStream(m_Adapter,this,targetTime);
...
::TianShanIce::Streamer::StreamPrx DummyService::createStreamByResource(const ::TianShanIce::SRM::ResourceMap&, const TianShanIce::Properties &,const ::Ice::Current& /*= ::Ice::Current()*/) 
{
	//check the resource first
	//WLock sync(*this);	
	tempPause();
	
	TianShanIce::Streamer::StreamPtr streamptr= new DummyStream(m_Adapter,this,targetTime);	
	//add some thing into database
...
//////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////
DummyStream::DummyStream( Ice::ObjectAdapterPtr adapter, DummyService* service , int targettime)
:m_Adapter(adapter),
m_Service(service) {	
	RLock sunc(*this);
...
void DummyStream::sendSpeedChange( ) {
	try {
...
void DummyStream::sendStateChange( ) {
	try {
...
void DummyStream::onTimer( const ::Ice::Current& /*= ::Ice::Current() */) {
	{
		WLock sync(*this);
		sendSpeedChange( );
		sendStateChange();
...
void DummyStream::allotPathTicket(const ::TianShanIce::Transport::PathTicketPrx&, const ::Ice::Current&/* = ::Ice::Current()*/) 
{
	RLock sunc(*this);
}
::Ice::Long DummyStream::seekStream(::Ice::Long, ::Ice::Int, const ::Ice::Current& /* = ::Ice::Current( */)
{
	RLock sunc(*this);
	tempPause();
	return 1;
}
void DummyStream::destroy(const ::Ice::Current& c) 
{
	::TianShanIce::Properties feedback; // simply throw away feedback returned from destory2()
	 destroy2(feedback, c);
}

void DummyStream::destroy2(::TianShanIce::Properties& feedback, const ::Ice::Current& c)
{
	{
		WLock sunc(*this);
		tempPause();
...
::std::string DummyStream::lastError(const ::Ice::Current&/* = ::Ice::Current()*/) const 
{
	RLock sunc(*this);
	return "Nothing";
}
...
::Ice::Identity DummyStream::getIdent(const ::Ice::Current&/* = ::Ice::Current()*/) const
{
	RLock sunc(*this);
...
void DummyStream::setConditionalControl(const ::TianShanIce::Streamer::ConditionalControlMask&, const ::TianShanIce::Streamer::ConditionalControlPrx&, const ::Ice::Current& /*= ::Ice::Current()*/)
{
	RLock sunc(*this);
...
bool DummyStream::play(const ::Ice::Current& /*= ::Ice::Current()*/) 
{
	RLock sunc(*this);
	tempPause();
	if(m_targetTime > 0)
...
bool DummyStream::setSpeed(::Ice::Float, const ::Ice::Current& /*= ::Ice::Current()*/) 
{
	RLock sunc(*this);
	tempPause();
	return true;
...
bool DummyStream::pause(const ::Ice::Current& /*= ::Ice::Current()*/) 
{
	RLock sunc(*this);
	tempPause();
	if(m_targetTime > 0)
...
bool DummyStream::resume(const ::Ice::Current& /*= ::Ice::Current()*/) 
{
	RLock sunc(*this);
	tempPause();
	return true;
...
::TianShanIce::Streamer::StreamState DummyStream::getCurrentState(const ::Ice::Current&/* = ::Ice::Current()*/) const 
{
	RLock sunc(*this);
	TianShanIce::Streamer::StreamState t =TianShanIce::Streamer::stsStreaming;
	return t;
}


::TianShanIce::SRM::SessionPrx DummyStream::getSession(const ::Ice::Current& /*= ::Ice::Current()*/) 
{
	RLock sunc(*this);
	return NULL;
}
...
void DummyStream::setMuxRate(::Ice::Int, ::Ice::Int, ::Ice::Int, const ::Ice::Current& /*= ::Ice::Current()*/) 
{
	RLock sunc(*this);
}


bool DummyStream::allocDVBCResource(::Ice::Int, ::Ice::Int, const ::Ice::Current& /*= ::Ice::Current()*/) 
{
	RLock sunc(*this);
	return true;
}
::std::string DummyStream::getId(const ::Ice::Current& /*= ::Ice::Current()*/) const 
{
	return ident.name;
}

bool DummyStream::getInfo(::Ice::Int mask , ::TianShanIce::ValueMap& varOut, const ::Ice::Current& /*= ::Ice::Current()*/)
{	
...
::Ice::Int DummyStream::insert(::Ice::Int, const ::TianShanIce::Streamer::PlaylistItemSetupInfo&,
							   ::Ice::Int, const ::Ice::Current&/* = ::Ice::Current()*/)
{
	return 1;
}

::Ice::Int DummyStream::pushBack(::Ice::Int, const ::TianShanIce::Streamer::PlaylistItemSetupInfo&,
					const ::Ice::Current&/* = ::Ice::Current()*/) 
{
	return 1;
}

::Ice::Int DummyStream::size(const ::Ice::Current&/* = ::Ice::Current()*/) const
{
	return 1;
}

::Ice::Int DummyStream::left(const ::Ice::Current&/* = ::Ice::Current()*/) const
{
	return 1;
}

bool DummyStream::empty(const ::Ice::Current&/* = ::Ice::Current()*/) const 
{
	return true;
}

::Ice::Int DummyStream::current(const ::Ice::Current&/* = ::Ice::Current()*/) const 
{
	return 1;
}

void DummyStream::erase(::Ice::Int, const ::Ice::Current&/* = ::Ice::Current()*/) 
{
	
}

::Ice::Int DummyStream::flushExpired(const ::Ice::Current&/* = ::Ice::Current()*/) 
{
	return 1;
}

bool DummyStream::clearPending(bool, const ::Ice::Current&/* = ::Ice::Current()*/) 
{
	return true;
}

bool DummyStream::isCompleted(const ::Ice::Current&/* = ::Ice::Current()*/) 
{
	return true;
}

::TianShanIce::IValues DummyStream::getSequence(const ::Ice::Current&/* = ::Ice::Current()*/) const 
{
	::TianShanIce::IValues lv;
	return lv;
}

::Ice::Int DummyStream::findItem(::Ice::Int, ::Ice::Int, const ::Ice::Current&/* = ::Ice::Current()*/)
{
	return 1;
}

bool DummyStream::distance(::Ice::Int, ::Ice::Int, ::Ice::Int&, const ::Ice::Current&/* = ::Ice::Current()*/)
{
	return true;
}

bool DummyStream::skipToItem(::Ice::Int, bool, const ::Ice::Current& /*= ::Ice::Current()*/)
{
	return true;
}

bool DummyStream::seekToPosition(::Ice::Int, ::Ice::Int, ::Ice::Int, const ::Ice::Current&/* = ::Ice::Current()*/)
{
	return true;
}
void DummyStream::play_async(const ::TianShanIce::Streamer::AMD_Stream_playPtr& callback, const ::Ice::Current& ) 
{
	tempPause();
	if(m_targetTime > 0)
		m_Service->mWatchDog.watch(ident.name, ZQ::common::now()+ m_targetTime);
...
void DummyStream::seekStream_async(const ::TianShanIce::Streamer::AMD_Stream_seekStreamPtr& callback, ::Ice::Long, ::Ice::Int, const ::Ice::Current& )
{
	tempPause();
	callback->ice_response(1);
}

void DummyStream::playEx_async(const ::TianShanIce::Streamer::AMD_Stream_playExPtr& callback, ::Ice::Float, ::Ice::Long, ::Ice::Short, const ::TianShanIce::StrValues&, const ::Ice::Current&)
{
	tempPause();
...
void DummyStream::skipToItem_async(const ::TianShanIce::Streamer::AMD_Playlist_skipToItemPtr& callback, ::Ice::Int, bool, const ::Ice::Current& )
{
	tempPause();
	callback->ice_response(true);
}

void DummyStream::seekToPosition_async(const ::TianShanIce::Streamer::AMD_Playlist_seekToPositionPtr& callback, ::Ice::Int, ::Ice::Int, ::Ice::Int, const ::Ice::Current& )
{
	tempPause();
	callback->ice_response(true);
}

void DummyStream::playItem_async(const ::TianShanIce::Streamer::AMD_Playlist_playItemPtr& callback, ::Ice::Int, ::Ice::Int, ::Ice::Short, ::Ice::Float, const ::TianShanIce::StrValues&, const ::Ice::Current& )
{
	tempPause();
	::TianShanIce::Streamer::StreamInfo info;
	callback->ice_response(info);
...
::TianShanIce::Streamer::StreamerDescriptors DummyService::listStreamers(const ::Ice::Current& )
{
	RLock sync(*this);
...
bool DummyService::connectToEventChannel( const std::string& endpoint )
{
...
Ice::ObjectPrx DummyService::getTopic( const std::string& topicName )
{
	if( !mTopicManagerPrx )
		return NULL;
...
//////////////////////////////////////////////////////////////////////////
ReplicaUpdater::ReplicaUpdater( DummyService& svc )
:mService(svc)
{
...
TianShanIce::Streamer::PlaylistExPrx TimerWatch::openStream( const std::string& id ) {
	try{
		return TianShanIce::Streamer::PlaylistExPrx::uncheckedCast( mDummyService->openPlaylist(id,::TianShanIce::Streamer::SpigotBoards(),true) );
	}
