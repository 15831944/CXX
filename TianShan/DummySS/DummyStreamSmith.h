// DummyStreamSmith.h: interface for the DummyStreamSmith class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_DUMMYSTREAMSMITH_H__69FFD043_BFCA_48F8_8FAC_3B414E227B07__INCLUDED_)
#define AFX_DUMMYSTREAMSMITH_H__69FFD043_BFCA_48F8_8FAC_3B414E227B07__INCLUDED_
...
class DummyStream:public TianShanIce::Streamer::PlaylistEx ,public IceUtil::AbstractMutexReadI<IceUtil::RWRecMutex>
{
public:
	DummyStream( Ice::ObjectAdapterPtr adapter, DummyService* service, int targettime = 1000);
	~DummyStream();		
...
{
public:
	FailOverFactory(Ice::ObjectAdapterPtr adapter,DummyService* service)
		: m_Adapter(adapter),
		m_Service( service)
	{;}
	~FailOverFactory(){;}
public:
	Ice::ObjectPtr create(const std::string& strID)
	{
		if( strID == TianShanIce::Streamer::Stream::ice_staticId ())
			return new DummyStream(m_Adapter,m_Service);
...
public:
	...
	TimerWatch( DummyService* service ):mDummyService(service),mbRunning(false){}
	virtual ~TimerWatch(){}
...
class DummyService : public TianShanIce::Streamer::StreamSmithAdmin,
	public IceUtil::AbstractMutexReadI<IceUtil::RWRecMutex>,
	public ZQ::common::NativeThread
{
public:
	DummyService(Ice::ObjectAdapterPtr& Adapter,const std::string& dbPath ,const std::string& netId,const std::vector<std::string>& streamers, int target = 1000 );
	~DummyService();
...
{
public:
	ReplicaUpdater( DummyService& svc );
...
private:
	DummyService&	mService;
	//HANDLE			mEvent;
	SYS::SingleObject	_replicaUpdaterEvent;
	bool			mbQuit;
};

#endif // !defined(AFX_DUMMYSTREAMSMITH_H__69FFD043_BFCA_48F8_8FAC_3B414E227B07__INCLUDED_)
