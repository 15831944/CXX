...
void	getValueMapDataWithDefault( const TianShanIce::ValueMap& value , const std::string& key , const Ice::Byte& valueDefault , Ice::Byte& valueOut , size_t pos )
{
	TianShanIce::ValueMap::const_iterator it = value.find( key );
	if( it == value.end() )
	{
...
void	getValueMapDataWithDefault( const TianShanIce::ValueMap& value , const std::string& key , const Ice::Int& valueDefault , Ice::Int& valueOut, size_t pos )
{
	TianShanIce::ValueMap::const_iterator it = value.find( key );
	if( it == value.end() )
	{
...
void	getValueMapDataWithDefault( const TianShanIce::ValueMap& value , const std::string& key , const Ice::Long& valueDefault , Ice::Long& valueOut, size_t pos )
{
	TianShanIce::ValueMap::const_iterator it = value.find( key );
	if( it == value.end() )
	{
...
void	getValueMapDataWithDefault( const TianShanIce::ValueMap& value , const std::string& key , const Ice::Float& valueDefault , Ice::Float& valueOut , size_t pos )
{
	TianShanIce::ValueMap::const_iterator it = value.find( key );
	if( it == value.end() )
	{
...
void	getValueMapDataWithDefault( const TianShanIce::ValueMap& value , const std::string& key ,const std::string& valueDefault , std::string& valueOut , size_t pos )
{
	TianShanIce::ValueMap::const_iterator it = value.find( key );
	if( it == value.end() )
	{
