...
void			getValueMapDataWithDefault( const TianShanIce::ValueMap& value , const std::string& key , const Ice::Byte& valueDefault , Ice::Byte& valueOut , size_t pos = 0);
...
void			getValueMapDataWithDefault( const TianShanIce::ValueMap& value , const std::string& key , const Ice::Int& valueDefault , Ice::Int& valueOut , size_t pos = 0 );
...
void			getValueMapDataWithDefault( const TianShanIce::ValueMap& value , const std::string& key , const Ice::Long& valueDefault , Ice::Long& valueOut , size_t pos = 0);
...
void			getValueMapDataWithDefault( const TianShanIce::ValueMap& value , const std::string& key , const Ice::Float& valueDefault , Ice::Float& valueOut , size_t pos = 0 );
...
void			getValueMapDataWithDefault( const TianShanIce::ValueMap& value , const std::string& key ,const std::string& valueDefault , std::string& valueOut , size_t pos = 0 );
