...
/*
enum HeNanResponseCode
{
	RspOK							= s,
	RspMovieUnavailable				= 0x0001,
	RspBandwidthUnavailable			= 0x0002,
	RspSystemError					= 0x0003,
	RspPurchaseDenied				= 0x0004,
	RspRentalNotFound				= 0x0005,
	RspLinearServiceNotAuthorized	= 0x0006,
	RspOnDemandServiceNotAuthorized	= 0x0007,
	RspFailedReturnRentalList		= 0x0008,
	RspFailedStoreSTB				= 0x0009,
	RspFailedDeleteRental			= 0x000A,
	RspFailedFindRental				= 0x000B,
	RspRequestDataUnparseable		= 0x000C,
	RspServerProcessingError		= 0x000D,
	RspRentalInUse					= 0x000E,
	RspTangbergBandwidthNotEnough		= 0x0012,
	RspTangbergNodGroupNotFound		= 0x0019,
	RspTangbergAssetNotFound              = 0x0020,
	//the PassThru Response codes
	RspOfferingNotFound				= 0x800F,
	RspPosterNotFound				= 0x8010,
	RspPosterNotAvailable			= 0x8011,
	RspPosterTooLarge				= 0x8012,
	RspOverallMesEXClientsLimit		= 0x8100,
	RspErrorReceivedInDataBlock		= 0x8101,
	RspRetryTimeout					= 0x8102,
//	RspPosterTooLarge				= 0x8103,
	RspWaitingOnClientACK			= 0x8150

};*/
enum HeNanResponseCode
{
	RspOK                = 0x0000,
	RspClNoSession   = 0x0001,
//	RspNeNoCalls      = 0x0002, 
	RspNeInvalidClient   = 0x0003, 
	RspNeInvalidServer  = 0x0004,
//	RspNeNoSession      = 0x0005,
	RspSeNoCalls         = 0x0006,
	RspSeInvalidClient  = 0x0007,
//	RspSeNoService      = 0x0008,
//	RspSeNoSession      = 0x0010,
	RSpSeNoBW           = 0x0012, 
	RspSRMRejected    =0x0019,
//	RspSeNoResource     = 0x0020,
//	RspSeProcError      = 0x0024, 
	RspSeFormatError    = 0x0027
};
...
enum {
	...
	lscErr_BadRequest    = 0x10, // lsc::LSC_BAD_REQUEST,
	lscErr_InvalidMethod = 0x12, // lsc::LSC_WRONG_STATE,
	lscErr_ServerErr     = 0x20, // lsc::LSC_SERVER_ERROR,
};
...
#define CRMetaData_ProtocolType          ClientRequestMetaData(protocolType) //std::string
...
//add for Protocol_Tangberg
#define CRMetaData_ServiceGateWay       ClientRequestMetaData(ServiceGateWay)//uint32 4byte
#define CRMetaData_Service              ClientRequestMetaData(Service)//uint32 4byte
#define CRMetaData_assetIdPayLoad       ClientRequestMetaData(assetIdPayLoad)//uint32 4byte
#define CRMetaData_AppPDprotocolId      ClientRequestMetaData(AppPDprotocolId)//uint32 4byte
#define CRMetaData_AppPDprotocolVersion ClientRequestMetaData(AppPDprotocolVersion)//uint32 4byte
...
//add for Protocol_Tangberg
#define CRMetaData_offeringId           ClientRequestMetaData(offeringId)//uint32 4byte (must)
#define CRMetaData_responseType         ClientRequestMetaData(responseType)//uint8 1byte(must)
