...
#ifndef __ZQTianShan_PathHelper_NSSEdgeRM_H__
#define __ZQTianShan_PathHelper_NSSEdgeRM_H__
...
#define STRMLINK_TYPE_TianShanNSSERM  "XOR-media.NSS.EdgeRM"

class NSSEdgeRMPHO : public ::Ice::LocalObject, public IStreamLinkPHO
{
public:

	NSSEdgeRMPHO(IPHOManager& mgr, ZQTianShan::EdgeRM::PhoEdgeRMEnv& env, ::ZQTianShan::AccreditedPath::EdgeRMPHO& edgermpho);
	virtual ~NSSEdgeRMPHO();
public:
...
protected:
	virtual void			validate_NSSEdgeRMStrmLinkConfig(const char* identStr, ::TianShanIce::ValueMap& configPD);
...
protected:
	...
	::ZQTianShan::AccreditedPath::EdgeRMPHO& _edgermpho;
private:
...
#endif // __ZQTianShan_PathHelper_NSSEdgeRM_H__
