...
void MCCSEngineSvc::doEnumSnmpExports()
{
	...
	SvcMIB_ExportReadOnlyVar("mediaClusterCS-netId",           &configGroup.mccsConfig.netId, AsnType_String, "");
	SvcMIB_ExportReadOnlyVar("mediaClusterCS-cacheMode",           &configGroup.mccsConfig.isCacheMode, AsnType_Int32, "");
	SvcMIB_ExportReadOnlyVar("mediaClusterCS-cacheLevel",           &configGroup.mccsConfig.cacheLevel, AsnType_Int32, "");
	SvcMIB_ExportReadOnlyVar("mediaClusterCS-threads",           &configGroup.mccsConfig.workerThreadSize, AsnType_Int32, "");

	SvcMIB_ExportReadOnlyVar("mediaClusterCS-Bind-endpoint",           &configGroup.mccsConfig.clusterEndpoint, AsnType_String, "");
	SvcMIB_ExportReadOnlyVar("mediaClusterCS-Bind-dispatchSize",           &configGroup.mccsConfig.dispatchSize, AsnType_Int32, "");
	SvcMIB_ExportReadOnlyVar("mediaClusterCS-Bind-dispatchMax",           &configGroup.mccsConfig.dispatchMax, AsnType_Int32, "");
	SvcMIB_ExportReadOnlyVar("mediaClusterCS-Provision-defaultBandwidth",           &configGroup.mccsConfig.defaultProvisionBW, AsnType_Int32, "");
	SvcMIB_ExportReadOnlyVar("mediaClusterCS-Provision-trickSpeeds",           &configGroup.mccsConfig.strTrickSpeeds, AsnType_String, "");

	SvcMIB_ExportReadOnlyVar("mediaClusterCS-DatabaseCache-volumeSize",           &configGroup.mccsConfig.volumeEvictorSize, AsnType_Int32, "");
	SvcMIB_ExportReadOnlyVar("mediaClusterCS-DatabaseCache-contentSize",           &configGroup.mccsConfig.contentEvictorSize, AsnType_Int32, "");
	SvcMIB_ExportReadOnlyVar("mediaClusterCS-DatabaseCache-contentSavePeriod",           &configGroup.mccsConfig.contentSavePeriod, AsnType_Int32, "");
	SvcMIB_ExportReadOnlyVar("mediaClusterCS-DatabaseCache-contentSaveSizeTrigger",           &configGroup.mccsConfig.contentSaveSizeTrigger, AsnType_Int32, "");
	SvcMIB_ExportReadOnlyVar("mediaClusterCS-CPC-Bind-endpoint",           &configGroup.mccsConfig.cpcEndPoint, AsnType_String, "");
}
