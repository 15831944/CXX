...
// module VolumeImpl
// -----------------------------
class VolumeImpl : public ::TianShanIce::Storage::VolumeEx, virtual public IceUtil::AbstractMutexReadI<IceUtil::RWRecMutex>
{
public:
...
// class ContentImpl
// -----------------------------
class ContentImpl : public TianShanIce::Storage::UnivContent, virtual public IceUtil::AbstractMutexReadI<IceUtil::RWRecMutex>
{
	friend class ContentStoreImpl;
...
// -----------------------------
class CachedContentListImpl : public TianShanIce::Storage::CachedContentList, virtual public IceUtil::AbstractMutexReadI<IceUtil::RWRecMutex>
{
	friend class CachedListContentsCmd;
