...
// ruler         "================================================================================" 
	...
	std::cout << "\n"
              ...
              << "createudp <IP> <PORT> [bitrate:3750000] create a playlist\n"
...
void SSAdmin::createudpPlaylist(const std::string& addr, uint16 port, int bitrate) {
    if(!checkConnection_()) {
        return;
    }
	...
	TianShanIce::SRM::ResourceMap res;
	ZQTianShan::Util::updateResourceData(res,TianShanIce::SRM::rtEthernetInterface,"destIP",addr);		
	ZQTianShan::Util::updateResourceData(res,TianShanIce::SRM::rtEthernetInterface,"destPort",(Ice::Int)port);		
	ZQTianShan::Util::updateResourceData(res,TianShanIce::SRM::rtTsDownstreamBandwidth,"bandwidth",(Ice::Long)bitrate);		
	ZQTianShan::Util::updateResourceData(res,TianShanIce::SRM::rtStreamer,"Type",(Ice::Int)1);		
    TRY_BEGIN
	::TianShanIce::Properties params;
	m_plPrx=PlaylistExPrx::uncheckedCast(m_AdminPrx->createStreamByResource(res, params));
