...
void StreamSmithService::doEnumSnmpExports()
{
	...
	SvcMIB_ExportReadOnlyVar("rtspProxy-RequestProcess-threads",           &gRtspProxyConfig.lServiceThreadCount, AsnType_Int32, "");
	SvcMIB_ExportReadOnlyVar("rtspProxy-RequestProcess-maxPendingRequest", &gRtspProxyConfig.lMaxPendingRequest, AsnType_Int32, "");
	SvcMIB_ExportReadOnlyVar("rtspProxy-EventPublisher-timeout",           &gRtspProxyConfig.lEventSinkTimeout, AsnType_Int32, "");
	SvcMIB_ExportReadOnlyVar("rtspProxy-SocketServer-rtspPort",            &gRtspProxyConfig.lRtspSocketServerPort, AsnType_Int32, "");
	SvcMIB_ExportReadOnlyVar("rtspProxy-SocketServer-maxConnections",      &gRtspProxyConfig.lMaxClientConnection, AsnType_Int32, "");
	SvcMIB_ExportReadOnlyVar("rtspProxy-SocketServer-threads",             &gRtspProxyConfig.lServiceFrameThreadPoolSize, AsnType_Int32, "");
	SvcMIB_ExportReadOnlyVar("rtspProxy-SocketServer-idleScanInterval",    &gRtspProxyConfig.lServiceFrameIdleTimeout, AsnType_Int32, "");
	SvcMIB_ExportReadOnlyVar("rtspProxy-SocketServer-maxSessions",         &gRtspProxyConfig.lMaxSessionCount, AsnType_Int32, "");
	SvcMIB_ExportReadOnlyVar("rtspProxy-SocketServer-IncomingMessage-maxLen", &gRtspProxyConfig.lIncomingMsgMaxLen, AsnType_Int32, "");
	...
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-since",             &_GlobalObject::perfmon.strStampSince,             AsnType_String, ".41");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-cReq",              &_GlobalObject::perfmon.requestCount,      AsnType_Int32, ".42");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-cSucc",             &_GlobalObject::perfmon.succeededCount,    AsnType_Int32, ".43");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-avgPLatency",       &_GlobalObject::perfmon.processedTimeAvg,  AsnType_Int32, ".44");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-maxPLatency",       &_GlobalObject::perfmon.processedTimePeak, AsnType_Int32, ".45");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-avgLatency",        &_GlobalObject::perfmon.durationAvg,       AsnType_Int32, ".46");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-maxLatency",        &_GlobalObject::perfmon.durationPeak,      AsnType_Int32, ".47");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-cSkipped",          &_GlobalObject::perfmon.skipCount,         AsnType_Int32, ".48");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-SETUP-latMax",      &_GlobalObject::perfmon.setupMax,          AsnType_Int32, ".49");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-SETUP-latMin",      &_GlobalObject::perfmon.setupMin,          AsnType_Int32, ".50");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-SETUP-latAvg",      &_GlobalObject::perfmon.setupAvarage,      AsnType_Int32, ".51");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-SETUP-cReq",        &_GlobalObject::perfmon.setupCount,        AsnType_Int32, ".52");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-SETUP-cSucc",       &_GlobalObject::perfmon.setupSucceededCount, AsnType_Int32, ".53");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-PLAY-latMax",       &_GlobalObject::perfmon.playMax,          AsnType_Int32, ".54");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-PLAY-latMin",       &_GlobalObject::perfmon.playMin,          AsnType_Int32, ".55");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-PLAY-latAvg",       &_GlobalObject::perfmon.playAvarage,      AsnType_Int32, ".56");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-PLAY-cReq",         &_GlobalObject::perfmon.playCount,        AsnType_Int32, ".57");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-PLAY-cSucc",        &_GlobalObject::perfmon.playSucceededCount, AsnType_Int32, ".58");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-GPARM-latMax",      &_GlobalObject::perfmon.getParaMax,          AsnType_Int32, ".59");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-GPARM-latMin",      &_GlobalObject::perfmon.getParaMin,          AsnType_Int32, ".60");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-GPARM-latAvg",      &_GlobalObject::perfmon.getParaAvarage,      AsnType_Int32, ".61");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-GPARM-cReq",        &_GlobalObject::perfmon.getParaCount,        AsnType_Int32, ".62");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-GPARM-cSucc",       &_GlobalObject::perfmon.getParaSucceededCount, AsnType_Int32, ".63");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-SPARM-latMax",      &_GlobalObject::perfmon.getParaMax,          AsnType_Int32, ".64");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-SPARM-latMin",      &_GlobalObject::perfmon.getParaMin,          AsnType_Int32, ".65");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-SPARM-latAvg",      &_GlobalObject::perfmon.getParaAvarage,      AsnType_Int32, ".66");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-SPARM-cReq",        &_GlobalObject::perfmon.getParaCount,        AsnType_Int32, ".67");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-SPARM-cSucc",       &_GlobalObject::perfmon.getParaSucceededCount, AsnType_Int32, ".68");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-OPTNS-latMax",      &_GlobalObject::perfmon.optionMax,          AsnType_Int32, ".69");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-OPTNS-latMin",      &_GlobalObject::perfmon.optionMin,          AsnType_Int32, ".70");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-OPTNS-latAvg",      &_GlobalObject::perfmon.optionAvarage,      AsnType_Int32, ".71");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-OPTNS-cReq",        &_GlobalObject::perfmon.optionCount,        AsnType_Int32, ".72");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-OPTNS-cSucc",       &_GlobalObject::perfmon.optionSucceededCount, AsnType_Int32, ".73");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-TRDWN-latMax",      &_GlobalObject::perfmon.teardownMax,          AsnType_Int32, ".74");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-TRDWN-latMin",      &_GlobalObject::perfmon.teardownMin,          AsnType_Int32, ".75");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-TRDWN-latAvg",      &_GlobalObject::perfmon.teardownAvarage,      AsnType_Int32, ".76");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-TRDWN-cReq",        &_GlobalObject::perfmon.teardownCount,        AsnType_Int32, ".77");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-TRDWN-cSucc",       &_GlobalObject::perfmon.teardownSucceededCount, AsnType_Int32, ".78");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-pendingReqs",       &_GlobalObject::pendingRequest, AsnType_Int32, ".79");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-activeThrds",       &_GlobalObject::activeThreads, AsnType_Int32, ".80");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat-lastIdleTime",      &_GlobalObject::lastIdleStampDelta, AsnType_Int32, ".81");

	SvcMIB_ExportReadOnlyVar("rtspProxy-stat10min-Responses",    &_GlobalObject::responseCounters.getCounter(RtspPerformance::ResponseCounters::ci_MAX)->countInWin,           AsnType_Int32, ".82");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat10min-SETUPs",       &_GlobalObject::responseCounters.getCounter(RtspPerformance::ResponseCounters::ci_SETUP)->countInWin,         AsnType_Int32, ".83");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat10min-PLAYs",        &_GlobalObject::responseCounters.getCounter(RtspPerformance::ResponseCounters::ci_PLAY)->countInWin,          AsnType_Int32, ".84");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat10min-PAUSEs",       &_GlobalObject::responseCounters.getCounter(RtspPerformance::ResponseCounters::ci_PAUSE)->countInWin,         AsnType_Int32, ".85");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat10min-TEARDOWNs",    &_GlobalObject::responseCounters.getCounter(RtspPerformance::ResponseCounters::ci_TEARDOWN)->countInWin,      AsnType_Int32, ".86");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat10min-GET_PARAMs",   &_GlobalObject::responseCounters.getCounter(RtspPerformance::ResponseCounters::ci_GET_PARAMETER)->countInWin, AsnType_Int32, ".87");

	SvcMIB_ExportReadOnlyVar("rtspProxy-stat10min-SETUPs-500",    &_GlobalObject::responseCounters.getCounter(RtspPerformance::ResponseCounters::ci_500_SETUP)->countInWin,         AsnType_Int32, ".88");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat10min-PLAYs-500",     &_GlobalObject::responseCounters.getCounter(RtspPerformance::ResponseCounters::ci_500_PLAY)->countInWin,          AsnType_Int32, ".89");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat10min-PAUSEs-500",    &_GlobalObject::responseCounters.getCounter(RtspPerformance::ResponseCounters::ci_500_PAUSE)->countInWin,         AsnType_Int32, ".90");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat10min-TEARDOWNs-500", &_GlobalObject::responseCounters.getCounter(RtspPerformance::ResponseCounters::ci_500_TEARDOWN)->countInWin,      AsnType_Int32, ".91");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat10min-GET_PARAMs-500",&_GlobalObject::responseCounters.getCounter(RtspPerformance::ResponseCounters::ci_500_GET_PARAMETER)->countInWin, AsnType_Int32, ".92");

	SvcMIB_ExportReadOnlyVar("rtspProxy-stat10min-SETUPs-503",    &_GlobalObject::responseCounters.getCounter(RtspPerformance::ResponseCounters::ci_503_SETUP)->countInWin,         AsnType_Int32, ".93");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat10min-PLAYs-503",     &_GlobalObject::responseCounters.getCounter(RtspPerformance::ResponseCounters::ci_503_PLAY)->countInWin,          AsnType_Int32, ".94");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat10min-PAUSEs-503",    &_GlobalObject::responseCounters.getCounter(RtspPerformance::ResponseCounters::ci_503_PAUSE)->countInWin,         AsnType_Int32, ".95");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat10min-TEARDOWNs-503", &_GlobalObject::responseCounters.getCounter(RtspPerformance::ResponseCounters::ci_503_TEARDOWN)->countInWin,      AsnType_Int32, ".96");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat10min-GET_PARAMs-503",&_GlobalObject::responseCounters.getCounter(RtspPerformance::ResponseCounters::ci_503_GET_PARAMETER)->countInWin, AsnType_Int32, ".97");

	SvcMIB_ExportReadOnlyVar("rtspProxy-stat10min-404s",          &_GlobalObject::responseCounters.getCounter(RtspPerformance::ResponseCounters::ci_404)->countInWin,       AsnType_Int32, ".98");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat10min-454s",          &_GlobalObject::responseCounters.getCounter(RtspPerformance::ResponseCounters::ci_454)->countInWin,       AsnType_Int32, ".99");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat10min-455s",          &_GlobalObject::responseCounters.getCounter(RtspPerformance::ResponseCounters::ci_455)->countInWin,       AsnType_Int32, ".100");
	SvcMIB_ExportReadOnlyVar("rtspProxy-stat10min-OtherErrs",     &_GlobalObject::responseCounters.getCounter(RtspPerformance::ResponseCounters::ci_OtherErrs)->countInWin, AsnType_Int32, ".101");

	SvcMIB_ExportReadOnlyVar("rtspProxy-stat10min-ANNOUNCEs",     &_GlobalObject::responseCounters.getCounter(RtspPerformance::ResponseCounters::ci_ANNOUNCE)->countInWin,  AsnType_Int32, ".300");
