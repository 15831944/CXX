...
void StreamSmithService::doEnumSnmpExports() {
	...
	SvcMIB_ExportReadOnlyVar("streamSmith-default-eventChannel-endpoint",		&gStreamSmithConfig.szEventChannelEndpoint, AsnType_String, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-default-CrashDump-path",				&gStreamSmithConfig.szMiniDumpPath, AsnType_String, "");

	SvcMIB_ExportReadOnlyVar("streamSmith-default-CrashDump-enabled",			&gStreamSmithConfig.lEnableMiniDump, AsnType_Int32, "");

	SvcMIB_ExportReadOnlyVar("streamSmith-default-IceTrace-enabled",			&gStreamSmithConfig.lEnableIceTrace, AsnType_Int32, "");

	SvcMIB_ExportReadOnlyVar("streamSmith-default-IceTrace-enabled",			&gStreamSmithConfig.lEnableIceTrace, AsnType_Int32, "");

	SvcMIB_ExportReadOnlyVar("streamSmith-default-IceTrace-size",				&gStreamSmithConfig.lIceLogSize, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-default-Database-path",				&gStreamSmithConfig.szFailOverDatabasePath, AsnType_String, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-netId",								&gStreamSmithConfig.szServiceID, AsnType_String, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-mode",								&gStreamSmithConfig.serverMode, AsnType_Int32, "");
	...
	SvcMIB_ExportReadOnlyVar("streamSmith-SuperPlugin-path",					&gStreamSmithConfig.szSuperPluginPath, AsnType_String, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-SuperPlugin-enabled",					&gStreamSmithConfig.lEnableSuperPlugin, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-SuperPlugin-eventSinkTimeout",		&gStreamSmithConfig.lEventSinkTimeout, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-SuperPlugin-enableShowDetail",		&gStreamSmithConfig.lEnableShowEventSinkDetail, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-Bind-endpoint",						&gStreamSmithConfig.szSvcEndpoint, AsnType_String, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-Bind-dispatchSize",					&gStreamSmithConfig.szAdapterThreadpoolSize, AsnType_String, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-Bind-dispatchMax",					&gStreamSmithConfig.szAdapterThreadpoolSizeMax, AsnType_String, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-RequestProcess-threads",				&gStreamSmithConfig.lServiceThreadCount, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-LocalResource-configuration",			&gStreamSmithConfig.szResourceManagerFileName, AsnType_String, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-LocalResource-Streamer-defaultSpigotId",	&gStreamSmithConfig.szDefaultSpigotID, AsnType_String, "");
	...
	SvcMIB_ExportReadOnlyVar("streamSmith-DatabaseCache-playlistSize",			&gStreamSmithConfig.lEvictorPlaylistSize, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-DatabaseCache-dbHealthCheckThreshold", &gStreamSmithConfig.lDbHealththreshold, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-DatabaseCache-itemSize",				&gStreamSmithConfig.lEvictorItemSize, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-Playlist-pauseWhenUnload",			&gStreamSmithConfig.lPauseWhenUnloadItem, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-Playlist-sessionScanInterval",		&gStreamSmithConfig.lVstrmSessionScanInterval, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-Playlist-bandwidthUsageScanInterval",	&gStreamSmithConfig.lBandwidthUsageScanInterval, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-Playlist-timeout",					&gStreamSmithConfig.lPlaylistTimeout, AsnType_Int32, "");
	...
	SvcMIB_ExportReadOnlyVar("streamSmith-Playlist-keepOnPause",				&gStreamSmithConfig.lKeepOnPause, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-Playlist-QueryLastItemPlayTime",		&gStreamSmithConfig.lQueryLastItemPlayTime, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-Playlist-progressInterval",			&gStreamSmithConfig.lProgressEventSendoutInterval, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-Playlist-EOTsize",					&gStreamSmithConfig.lEOTProtectionTime, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-Playlist-PreLoadTime",				&gStreamSmithConfig.lPreloadTime, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-Playlist-ForceNormalTimeBeforeEnd",	&gStreamSmithConfig.lForceNormalTimeBeforeEnd, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-Playlist-delayedCleanup",				&gStreamSmithConfig.lKillPlInterval, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-Playlist-repositionInaccuracy",		&gStreamSmithConfig.lRepositioInaccuracy, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-CriticalStartPlayWait-enabled",		&gStreamSmithConfig.lEnablemaxWaitTimeToStartFirstItem, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-CriticalStartPlayWait-timeout",		&gStreamSmithConfig.lmaxWaitTimeToStartFirstItem, AsnType_Int32, "");
	...
	SvcMIB_ExportReadOnlyVar("streamSmith-MotoPreEncryption-cycle1",			&gStreamSmithConfig.lEncryptionCycle1, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-MotoPreEncryption-freq1",				&gStreamSmithConfig.lEncryptionFreq1, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-MotoPreEncryption-cycle2",			&gStreamSmithConfig.lEncryptionCycle2, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-MotoPreEncryption-freq2",				&gStreamSmithConfig.lEncryptionFreq2, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-Plugin-log-level",					&gStreamSmithConfig.lPluginLogLevel, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-Plugin-log-fileSize",					&gStreamSmithConfig.lPluginLogSize, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-Plugin-log-buffer",					&gStreamSmithConfig.lPluginLogBuffer, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-Plugin-log-flushTimeout",				&gStreamSmithConfig.lPluginLogTimeout, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-SessionMonitor-log-level",			&gStreamSmithConfig.lSessMonLogLevel, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-SessionMonitor-log-fileSize",			&gStreamSmithConfig.lSessMonLogSize, AsnType_Int32, "");
	...
	SvcMIB_ExportReadOnlyVar("streamSmith-SessionMonitor-log-buffer",			&gStreamSmithConfig.lSessMonLogBuffer, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-SessionMonitor-log-flushTimeout",		&gStreamSmithConfig.lSessMonLogTimeout, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-PerfTune-IceFreezeEnvironment-CheckpointPeriod",	&gStreamSmithConfig.szIceEnvCheckPointPeriod, AsnType_String, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-PerfTune-IceFreezeEnvironment-DbRecoverFatal",	&gStreamSmithConfig.szIceEnvDbRecoverFatal, AsnType_String, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-PerformanceTune-playlist-SavePeriod",				&gStreamSmithConfig.szFreezePlaylistSavePeriod, AsnType_String, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-PerformanceTune-playlist-SaveSizeTrigger",		&gStreamSmithConfig.szFreezePlaylistSaveSizeTrigger, AsnType_String, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-PerformanceTune-item-SavePeriod",					&gStreamSmithConfig.szFreezeItemSavePeriod, AsnType_String, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-PerformanceTune-item-SaveSizeTrigger",			&gStreamSmithConfig.szFreezeItemSaveSizeTrigger, AsnType_String, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-SocketServer-enabled",							&gStreamSmithConfig.lIsSvcFrameWork, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-SocketServer-rtspPort",							&gStreamSmithConfig.lRtspSocketServerPort, AsnType_Int32, "");
	...
	SvcMIB_ExportReadOnlyVar("streamSmith-SocketServer-lscpPort",							&gStreamSmithConfig.lLscpSocketServerPort, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-SocketServer-maxConnections",						&gStreamSmithConfig.lMaxClientConnection, AsnType_Int32, "");

	SvcMIB_ExportReadOnlyVar("streamSmith-SocketServer-threads",							&gStreamSmithConfig.lServiceFrameThreadPoolSize, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-SocketServer-threadPriority",						&gStreamSmithConfig.lServiceFrameThreadPriority, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-SocketServer-debugLevel",							&gStreamSmithConfig.lServiceFrameDebugLevel, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-SocketServer-debugDetail",						&gStreamSmithConfig.lServiceFrameDebugDetail, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-SocketServer-idleTimeout",						&gStreamSmithConfig.lServiceFrameIdleTimeout, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-SocketServer-idleScanInterval",					&gStreamSmithConfig.lServiceFrameIdleScanInterval, AsnType_Int32, "");
	
	SvcMIB_ExportReadOnlyVar("streamSmith-SocketServer-SSL-enabled",						&gStreamSmithConfig.lServiceFrameSSLEnabled, AsnType_Int32, "");
	...
	SvcMIB_ExportReadOnlyVar("streamSmith-IncomingMessage-maxLen",							&gStreamSmithConfig.lIncomingMsgMaxLen, AsnType_Int32, "");	
}
