...
// class Playlist
// -----------------------------
const long PLISFlagNoPause = 0x0001; // (1<<0) forbid pause the item if this flag is on
const long PLISFlagNoFF    = 0x0002; // (1<<1) forbid fastforward the item if this flag is on
const long PLISFlagNoRew   = 0x0004; // (1<<2) forbid rewind the item if this flag is on
const long PLISFlagNoSeek  = 0x0008; // (1<<3) forbid seek the item if this flag is on
const long PLISFlagOnce	   = 0x0010;
...
//	long			GetForceNormalTimeOnPuaseTV(){return _forceNormalPlayTimeOnPauseTV;}
	bool			GetTimeoutOnPause(){return _bTimeoutOnPause;}
	////
