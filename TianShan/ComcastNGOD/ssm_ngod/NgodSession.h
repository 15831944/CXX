...
public:
	...
	void					addSCEventRecord( const std::string& targetState , const std::string& newState , const std::string& strNptStart , const std::string& scale , const std::string& streamResourceId, const std::string& userTime, int status = 200, const std::string& reqRange = "", const std::string& reqScale = "" );
	void					addTDEventRecord( const std::string& reason , const std::string& strNpt , const std::string& stopIdx );
	void					addTSEventRecord( const NGOD::StreamEventAttr& a);
	void					addRPEventRecord( const NGOD::StreamEventAttr& a);
...
protected:
	...
	bool					getCachedSsInfo( StreamSessionInfo& info );
...
protected:
	...
	void					addEventRecord( const SessionEventRecord& record );
