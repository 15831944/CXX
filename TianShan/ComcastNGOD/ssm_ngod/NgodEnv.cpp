...
_mmib(mainLogger, 1000, 3), _snmpSA(mainLogger, _mmib, 5000)
{
	...
	_mmib.addObject(new ZQ::SNMP::SNMPObject("ngod2-LogFile-size",           &ngodConfig.pluginLog.size,    ZQ::SNMP::AsnType_Int32));
	_mmib.addObject(new ZQ::SNMP::SNMPObject("ngod2-LogFile-level",          &ngodConfig.pluginLog.level,   ZQ::SNMP::AsnType_Int32));
	_mmib.addObject(new ZQ::SNMP::SNMPObject("ngod2-eventChannel-endpoint",  &ngodConfig.iceStorm.endpoint, ZQ::SNMP::AsnType_String));
	_mmib.addObject(new ZQ::SNMP::SNMPObject("ngod2-Bind-endpoint",          &ngodConfig.bind.endpoint,     ZQ::SNMP::AsnType_String));
	_mmib.addObject(new ZQ::SNMP::SNMPObject("ngod2-RTSPSession-timeout",    &ngodConfig.rtspSession.timeout,   ZQ::SNMP::AsnType_Int32));
	_mmib.addObject(new ZQ::SNMP::SNMPObject("ngod2-RTSPSession-cacheSize",  &ngodConfig.rtspSession.cacheSize,   ZQ::SNMP::AsnType_Int32));
	_mmib.addObject(new ZQ::SNMP::SNMPObject("ngod2-RTSPSession-defaultServiceGroup",    &ngodConfig.rtspSession.defaultServiceGroup,   ZQ::SNMP::AsnType_Int32));
	_mmib.addObject(new ZQ::SNMP::SNMPObject("ngod2-Database-path",                      &ngodConfig.database.path,   ZQ::SNMP::AsnType_String));
	_mmib.addObject(new ZQ::SNMP::SNMPObject("ngod2-Announce-useGlobalCSeq",             &ngodConfig.announce.useGlobalCSeq,   ZQ::SNMP::AsnType_Int32));

	_mmib.addObject(new ZQ::SNMP::SNMPObject("ngod2-Response-setupFailureWithSessId",   &ngodConfig.response.setupFailureWithSessId,    ZQ::SNMP::AsnType_Int32));
	_mmib.addObject(new ZQ::SNMP::SNMPObject("ngod2-Response-streamCtrlPort",          &ngodConfig.response.streamCtrlProt,   ZQ::SNMP::AsnType_String));
	_mmib.addObject(new ZQ::SNMP::SNMPObject("ngod2-playlistControl-enableEOT",          &ngodConfig.playlistControl.enableEOT,   ZQ::SNMP::AsnType_Int32));

	_mmib.addObject(new ZQ::SNMP::SNMPObject("ngod2-LAM-TestMode-enabled",             &ngodConfig.lam.lamTestMode,    ZQ::SNMP::AsnType_Int32, true)); // TODO: false)); to be writeable
