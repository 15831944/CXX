...
enum SopUsageAttrType 
{
    ...
    STREAMER_SNMPTYPE_VOLUME    		=	13,		//sopVolume
};
...
enum ImportChannelAttrType
{
    ...
    IMPORTCHANNEL_SNMPTYPE_STATUS   	=	4
};
...
protected:
	...
	bool		getVariableWithType( const NGOD::StreamerUsage& streamerUsage, ZQ::Snmp::SmiValue& val , ZQ::Snmp::AsnType desiredType  ) const;
...
protected:
	...
	bool		getVariableWithType( const NGOD::ImportChannelUsage& importChannelUsage, ZQ::Snmp::SmiValue& val , ZQ::Snmp::AsnType desiredType  ) const;
...
public:
	...
	bool					registerSnmpTable(IStreamSmithSite* pSite);
