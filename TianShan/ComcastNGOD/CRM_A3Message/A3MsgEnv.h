...
namespace CRM
{
	namespace A3Message
	{
		...
		public:
			bool addContentInfo(std::string contentName, ContentInfo contentInfo);
			bool removeContentInfo(std::string contentName);
			ContentInfo getContentInfo(std::string contentName);
