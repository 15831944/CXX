...
#define ZQ_FILE_DESCRIPTION        	ZQ_PRODUCT_NAME ": ContentLib Client"
#ifdef _DEBUG
#define ZQ_INTERNAL_FILE_NAME      	"ContentLibClient_d"
#else
#define ZQ_INTERNAL_FILE_NAME      	"ContentLibClient"
#endif // _DEBUG
