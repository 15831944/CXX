...
static void registerSnmp(const char* logFilename, int nLogFileSize, SV_t *pSV)
{
    ...
    mmib->addObject(new ZQ::SNMP::SNMPObject("LoggingMask", 	    &pSV->dwLoggingMask, 	ZQ::SNMP::AsnType_Int32), 	     ".1");
    mmib->addObject(new ZQ::SNMP::SNMPObject("SnmpLoggingMask", 	&pSV->dwSnmpLoggingMask,ZQ::SNMP::AsnType_Int32), 	     ".2");
    mmib->addObject(new ZQ::SNMP::SNMPObject("LogDir", 	            &pSV->szLogfilePath, 	ZQ::SNMP::AsnType_String), 	     ".3");
    mmib->addObject(new ZQ::SNMP::SNMPObject("LogfileSize", 	    &pSV->dwLogfileSize, 	ZQ::SNMP::AsnType_Int32), 	     ".4");
    mmib->addObject(new ZQ::SNMP::SNMPObject("LoggingLevel", 	    &pSV->dwLoggingLevel, 	ZQ::SNMP::AsnType_Int32, false), ".5");
    mmib->addObject(new ZQ::SNMP::SNMPObject("ImagePath", 		    &pSV->szImagePath, 	    ZQ::SNMP::AsnType_String), 	     ".6");
    mmib->addObject(new ZQ::SNMP::SNMPObject("AliveTimeout", 	    &pSV->dwAliveTimeout,   ZQ::SNMP::AsnType_Int32), 	     ".7");
    mmib->addObject(new ZQ::SNMP::SNMPObject("Restart Threshold", 	&pSV->dwRestartTries, 	ZQ::SNMP::AsnType_Int32, false), ".8");
    mmib->addObject(new ZQ::SNMP::SNMPObject("RestartInterval", 	&pSV->dwRestartInterval,ZQ::SNMP::AsnType_Int32, false), ".9");
    mmib->addObject(new ZQ::SNMP::SNMPObject("RestartDelay", 		&pSV->dwRestartDelay, 	ZQ::SNMP::AsnType_Int32), 	     ".10");
    mmib->addObject(new ZQ::SNMP::SNMPObject("Last Restart", 		&pSV->szLastStart, 		ZQ::SNMP::AsnType_String), 	     ".11");
    mmib->addObject(new ZQ::SNMP::SNMPObject("StartTimeout", 	    &pSV->dwStartTimeout, 	ZQ::SNMP::AsnType_Int32, false), ".12");

    mmib->addObject(new ZQ::SNMP::SNMPObject("IsServiceTypeShare", 	&bIsServiceTypeShare, 	ZQ::SNMP::AsnType_Int32), 	     ".13");
    mmib->addObject(new ZQ::SNMP::SNMPObject("Total Starts", 		&pSV->dwTotalStarts, 	ZQ::SNMP::AsnType_Int32), 	     ".14");
    mmib->addObject(new ZQ::SNMP::SNMPObject("StopTimeout", 	    &pSV->dwStopTimeout, 	ZQ::SNMP::AsnType_Int32, false), ".15");
    mmib->addObject(new ZQ::SNMP::SNMPObject("RebootOnExit", 		&pSV->bRebootOnExit, 	ZQ::SNMP::AsnType_Int32, false), ".16");  
    mmib->addObject(new ZQ::SNMP::SNMPObject("KillCheckTime", 	    &pSV->dwKillCheckTime,  ZQ::SNMP::AsnType_Int32), 	     ".17");
    mmib->addObject(new ZQ::SNMP::SNMPObject("KillCheckCount", 	    &pSV->dwKillCheckCount, ZQ::SNMP::AsnType_Int32), 	     ".18");
