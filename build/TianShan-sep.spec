...
%define svc_daemons   EventChannel Sentry CDNCS CDNSS GBCS CPESvc HttpCRG RtspProxy EventGateway EventRuleEngine ContentLib Weiwoo SiteAdmin MODApp xmlshd EdgeRM NSS GBMODApp DsmccCRG GBVSS TSPump MediaClusterCS DummySvc
...
if [ "%{_build_arch}" = "x86_64" ]; then
	...
	cp -vp %{src_bin_dir}/{libEGH*,libSSM*,libCRM*,libCPH*,libAction*,libMHO*,libPHO*} %{dest_mod_dir}
else
	...
	cp -vp %{src_bin_dir}/{libEGH*,libSSM*,libCRM*,libAction*,libMHO*,libPHO*} %{dest_mod_dir}
fi
