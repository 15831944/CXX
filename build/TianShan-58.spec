...
%define odbc_dir	%{sdk_dir}/3rdPartyKits/odbc
%define myodbc_dir	%{sdk_dir}/3rdPartyKits/odbc
...
%define svc_daemons   EventChannel Sentry CDNCS CDNSS CPESvc HttpCRG RtspProxy EventGateway EventRuleEngine ContentLib Weiwoo SiteAdmin MODSvc xmlshd EdgeRM NSS GBMODApp DsmccCRG GBVSS TSPump MediaClusterCS C2SS DummySvc BcastChannel
...
%define dep_misc      snmp snmp++ db_cxx boost_regex boost_thread boost_system icu nl

%define ice_ver       3.2.2
%define ice_ver_maj   32
%define boost_ver     1.56.0
%define boost_ver_maj 1
%define boost_thread_ver     1.56.0
%define boost_thread_ver_maj 1
%define boost_system_ver     1.56.0
%define boost_system_ver_maj 1
...
%define odbc_ver      2.0.0
%define odbc_ver_maj  2
%define myodbc_ver     	5.1.13
%define myodbc_ver_maj  5
...
%{boost_dir}/lib64/{libboost_regex.so.%{boost_ver},libboost_regex.so} \
%{boost_dir}/lib64/{libboost_thread.so.%{boost_thread_ver},libboost_thread.so} \
%{boost_dir}/lib64/{libboost_system.so.%{boost_system_ver},libboost_system.so} \
...
%{odbc_dir}/lib64/{libodbc.so.%{odbc_ver},libodbc.so.%{odbc_ver_maj}} \
%{odbc_dir}/lib64/{libodbcinst.so.%{odbc_ver},libodbcinst.so.%{odbc_ver_maj}} \
%{dest_bin_dir}
